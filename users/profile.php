...
$query=mysqli_query($con,"update users set fullName='$fname',contactNo='$contactno',department='$department',address='$address',State='$state',country='$country',pincode='$pincode' where userEmail='".$_SESSION['login']."'");
if($query)
{
$successmsg="Profile Successfully Saved !!";
}
else
{
...
<html lang="en">
  <head>
    ...
    <title>SHCGs | User Profile</title>
...
<input type="email" name="useremail" required="required" value="<?php echo htmlentities($row['userEmail']);?>" class="form-control" readonly>
 ...
 <!-- I make changes in 105 to 110th lines -->
<div class="form-group">
  <label class="col-sm-2 col-sm-2 control-label">Register Number</label>
  <div class="col-sm-4">
  ...
  <div class="col-sm-4">
    <input type="text" name="department" required="required" value="<?php echo htmlentities($row['department']);?>" class="form-control">
  </div>
</div>
